...
if ($con->query("update users SET email='$_POST[email]',password='$_POST[password]' , name='$_POST[name]',number='$_POST[number]' where id='$_SESSION[userId]'")) {
...
//   $note ="<div class='alert alert-success'>Successfully Saved</div>";
//   header("location:accountSetting.php?note=Successfully saved");
// }
// else{
//   $note ="<div class='alert alert-danger'>خطأ:".$con->error."</div>";
// }
// }
// if (isset($_GET['note'])) {
//   $note = "<div class='alert alert-success'>تم الحفظ بنجاح</div>";
// }
 ?>
  ...
  <div class="content-category">
    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <form method="POST">
        ...
        <a href="addnewaccount.php"><button class="btn btn-success btn-sm " style="margin: 20px 0 0"> اضافة حساب مستخدم اخر </button> </a>
    </div>
</div>
